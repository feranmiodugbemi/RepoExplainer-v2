    ...
    <main class="flex-1 flex flex-col">
      <section class="flex-1 flex flex-col">
        <div class="flex-1 flex flex-col">
          ...
          <div class="bg-white dark:bg-gray-950 p-4 md:p-6 border-t border-gray-200 dark:border-gray-800 flex-shrink-0">
            <div class="relative">
              <textarea
            ...
            <p class="text-xs text-center text-neutral-700 font-medium dark:text-neutral-400">
